...
export default function CounterForm() {
  ...
  return (
    <div className={styles.styleForm}>
      ...
      <h2 className={styles.styleMainTitle}>Crear Contador</h2>

      <div className={styles.styleField}>
        <label className={styles.styleLabel}>Nombre del evento</label>
        <input
          type="text"
          value={name}
      ...
      <div className={styles.styleField}>
        <label className={styles.styleLabel}>Fecha</label>
          <DayPicker
          mode="single"
      ...
      <div className={styles.styleField}>
        <label className={styles.styleLabel}>Hora (24h)</label>
        <TimePicker
          onChange={setTime}
          value={time}
          format="HH:mm"
      ...
      <div className={styles.styleField}>
        <label className={styles.styleLabel}>Zona horaria</label>
        <select
          value={timezone}
